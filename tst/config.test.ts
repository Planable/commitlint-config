...
describe("Invalid commits", () => {
  test.concurrent.each([
    ...
    ["To much space after emoji", "✅  [P-4605] Add tests", "header-match-planable-pattern"],
    ["To much space after ticket", "✅ [P-4605]  Add tests", "header-match-planable-pattern"],
    ["To much space before subject", "✅  Add tests", "header-match-planable-pattern"],
